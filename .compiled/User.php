...
class User extends Foundation\AbstractActorDP {
    ...
    public function __construct(\Pho\Kernel\Kernel $kernel, \Pho\Lib\Graph\GraphInterface $graph , string $username, string $email, string $password, ?string $avatar = "", ?string $birthday = "01/15/1983", ?string $about = "", ?bool $is_editor = true, ?string $custom_field1 = "", ?string $custom_field2 = "", ?string $custom_field3 = "", ?bool $pending = false, ?int $pending_verification = 0)
    {
        ...
        if(class_exists(\PhoNetworksAutogenerated\Edges\Pin::class))
            $this->registerOutgoingEdges(\PhoNetworksAutogenerated\Edges\Pin::class);
 ...
 * Size (in bytes): 7539
 * Compilation Time: 35
 * 306f98771aac9bf96a3ef00d13f5b694
 ******************************************************/